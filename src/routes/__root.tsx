...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Galway-based creative production company delivering festivals, public programmes, conferences and cultural experiences across Ireland." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Milestone Inventive" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Milestone Inventive — Creative production for cultural moments" },
      { name: "twitter:description", content: "Galway-based creative production company delivering festivals, public programmes, conferences and cultural experiences across Ireland." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/21a2d38c-97d2-4989-a8b9-74a42757e665/id-preview-d61d17eb--10bda7e0-4916-4928-a9d0-4ec8b1d4a624.lovable.app-1778845832620.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/21a2d38c-97d2-4989-a8b9-74a42757e665/id-preview-d61d17eb--10bda7e0-4916-4928-a9d0-4ec8b1d4a624.lovable.app-1778845832620.png" },
    ],
    links: [
